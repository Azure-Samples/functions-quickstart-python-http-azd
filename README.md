...
By default, this sample deploys with a virtual network for enhanced security. Alternatively, you can opt-out of a VNet being used in the sample by setting `VNET_ENABLED` to `false` before running `azd up`:
